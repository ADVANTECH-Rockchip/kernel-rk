...
#define RT5660_ALC_PGA_CTRL4			0xee
#define RT5660_ALC_PGA_CTRL5			0xef
#define RT5660_ALC_PGA_CTRL6			0xf0
...
#define RT5660_DAC_L1_VOL_MASK			(0xff << 8)
#define RT5660_DAC_L1_VOL_SFT			8
#define RT5660_DAC_R1_VOL_MASK			(0xff)
#define RT5660_DAC_R1_VOL_SFT			0

/* ADC Digital Volume Control (0x1c) */
#define RT5660_ADC_L_VOL_MASK			(0x7f << 8)
#define RT5660_ADC_L_VOL_SFT			8
#define RT5660_ADC_R_VOL_MASK			(0x7f)
#define RT5660_ADC_R_VOL_SFT			0
...
#define RT5660_G_BST4_RM_L_MASK			(0x7 << 7)
#define RT5660_G_BST4_RM_L_SFT			7
...
#define RT5660_M_BST4_RM_L			(0x1 << 4)
#define RT5660_M_BST4_RM_L_SFT			4
...
#define RT5660_G_BST4_RM_R_MASK			(0x7 << 7)
#define RT5660_G_BST4_RM_R_SFT			7
...
#define RT5660_M_BST4_RM_R			(0x1 << 4)
#define RT5660_M_BST4_RM_R_SFT			4
...
#define RT5660_G_BST4_OM_R_MASK			(0x7 << 13)
#define RT5660_G_BST4_OM_R_SFT			13
...
#define RT5660_M_BST4_OM_R			(0x1 << 5)
#define RT5660_M_BST4_OM_R_SFT			5
...
#define RT5660_PWR_BST4				(0x1 << 12)
#define RT5660_PWR_BST4_BIT			12
...
/* Volume Rescale */
#define RT5660_VOL_RSCL_MAX 0x27
#define RT5660_VOL_RSCL_RANGE 0x1F
/* Debug String Length */
#define RT5660_REG_DISP_LEN 23

#define RT5660_NO_JACK		BIT(0)
#define RT5660_HEADSET_DET	BIT(1)
#define RT5660_HEADPHO_DET	BIT(2)

int rt5660_headset_detect(struct snd_soc_codec *codec, int jack_insert);
...
struct rt5660_priv {
	...
	int codec_avdd_gpio;
	int codec_avdd_gpio_active;
	int codec_micvdd_gpio;
	int codec_micvdd_gpio_active;
	int codec_spkvdd_gpio;
	int codec_spkvdd_gpio_active;
	int amp_shutdown_gpio;
	int amp_shutdown_gpio_active;
	int amp_mute_gpio;
